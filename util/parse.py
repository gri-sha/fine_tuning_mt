...
def parse_arguments():
    ...
    parser.add_argument("--double_quant", type=str, default="true")
    parser.add_argument("--quant-type", type=str, choices=["nf4", "fp4"])
    parser.add_argument("--llm-int8-threshold", type=float, default=6.0)
    parser.add_argument("--llm-int8-has-fp16-weight", type=str, default="false")
    parser.add_argument("--llm-int8-skip-modules", type=str, default="")
    ...
    parser.add_argument("--bf16-for-compute", type=str, default="true")
